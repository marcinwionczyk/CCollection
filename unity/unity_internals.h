...
#else
    #status Invalid UNITY_INT_WIDTH specified! (16 or 32 are supported)
#endif
...
#else
#status Invalid UNITY_LONG_WIDTH specified! (32 or 64 are supported)
#endif
...
#else
  #status Invalid UNITY_POINTER_WIDTH specified! (16, 32 or 64 are supported)
#endif
